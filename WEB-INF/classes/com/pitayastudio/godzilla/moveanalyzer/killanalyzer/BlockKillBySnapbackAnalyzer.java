...
/** TODO 400 implement BlockKillBySnapbackAnalyzer. */
public class BlockKillBySnapbackAnalyzer extends KillAnalyzer {
  ...
  private BlockKillBySnapbackAnalyzer(
  ...
  public static class Builder {
    ...
    public BlockKillBySnapbackAnalyzer build() {
      ...
      calculateBestMoves();
      return new BlockKillBySnapbackAnalyzer(analyzerBoard, targetBlock, bestNextAnalyzerBoards, bestMoveCoords,
          isReverseMode);
    }
