...
/**
 * TODO 400 implement BlockKillByNetAnalyzer.
 * @see DesignDoc#moveToCapture
 */
public class BlockKillByNetAnalyzer extends KillAnalyzer {
  ...
  private BlockKillByNetAnalyzer(
  ...
  public static class Builder {
    ...
    public BlockKillByNetAnalyzer build() {
      ...
      calculateBestMoves();
      return new BlockKillByNetAnalyzer(analyzerBoard, targetBlock, bestNextAnalyzerBoards, bestMoveCoords,
          isReverseMode);
    }
