...
/**
 * TODO 400 implement BlockKillByGongshaAnalyzer.
 * @see DesignDoc#killByGongsha()
 */
public class BlockKillByGongshaAnalyzer extends KillAnalyzer {
  ...
  @SuppressWarnings("unused") private final ColorBlock buddyBlock;
  ...
  public static class Builder {
    ...
    public Builder setRequiredBuddyBlock(@Nonnull ColorBlock buddyBlock) {
      this.buddyBlock = buddyBlock;
      return this;
    }
    ...
    public BlockKillByGongshaAnalyzer build() {
      assert (null != targetBlock);
      assert (null != buddyBlock);
      ...
      calculateBestMoves();
      return new BlockKillByGongshaAnalyzer(analyzerBoard, targetBlock, buddyBlock, bestNextAnalyzerBoards,
